...
class IPWebcamApp:
    def __init__(self, root, url, esp32_ip):  # Ensure double underscores here
        self.root = root
...
class IPWebcamApp:
    def __init__(self, root, url, esp32_ip):  # Corrected __init__ method
        self.root = root
        self.root.title("IP Webcam Stream")
        self.url = url
        self.esp32_ip = esp32_ip
    ...
    def replay_path(self):
        ...
        def replay():
            ...
            time.sleep(2 * 60)  # Pause for 2 minutes
    ...
    def __del__(self):  # Corrected __del__ method
